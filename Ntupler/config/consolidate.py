...
aparser.add_argument('-base'  ,'--base'     ,nargs='+',type=str,default=['05'])
aparser.add_argument('-mod'  ,'--mod'       ,nargs='+',type=str,default=[20])
...
def clear():
    ...
    os.system('mv *.root tmp')
    os.system('cmsStage tmp/%s_%s.root /store/cmst3/group/monojet/production/%s/%s/' % (args.dir[0],basecount,args.base[0],args.dir[0]))
    count=0
