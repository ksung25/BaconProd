...
#JEC
JECTag='Summer16_03Feb2017_V9_MC'
if is_data_flag: 
  JECTag='Summer16_03Feb2017All_V9_DATA'
...
process.ntupler = cms.EDAnalyzer('NtuplerMod',
  ...
  AK4Puppi = cms.untracked.PSet(
    ...
    deepDoubleBTagProbQName = cms.untracked.string('AK4PFBoostedDeepDoubleBJetTagsPuppi:probQ'),
    deepDoubleBTagProbHName = cms.untracked.string('AK4PFBoostedDeepDoubleBJetTagsPuppi:probH'),
  ...
  AK8CHS = cms.untracked.PSet(
    ...
    deepDoubleBTagProbQName   = cms.untracked.string('AK8PFBoostedDeepDoubleBJetTagsCHS:probQ'),
    deepDoubleBTagProbHName   = cms.untracked.string('AK8PFBoostedDeepDoubleBJetTagsCHS:probH'),
  ...
  CA8CHS = cms.untracked.PSet(
    ...
    deepDoubleBTagProbQName   = cms.untracked.string('CA8PFBoostedDeepDoubleBJetTagsCHS:probQ'),
    deepDoubleBTagProbHName   = cms.untracked.string('CA8PFBoostedDeepDoubleBJetTagsCHS:probH'),
  ...
  AK8Puppi = cms.untracked.PSet(
    ...
    deepDoubleBTagProbQName = cms.untracked.string('AK8PFBoostedDeepDoubleBJetTagsPuppi:probQ'),
    deepDoubleBTagProbHName = cms.untracked.string('AK8PFBoostedDeepDoubleBJetTagsPuppi:probH'),
  ...
  CA15CHS = cms.untracked.PSet(
    ...
    deepDoubleBTagProbQName = cms.untracked.string('CA15PFBoostedDeepDoubleBJetTagsCHS:probQ'),
    deepDoubleBTagProbHName = cms.untracked.string('CA15PFBoostedDeepDoubleBJetTagsCHS:probH'),
  ...
  CA15Puppi = cms.untracked.PSet(
    ...
    deepDoubleBTagProbQName = cms.untracked.string('CA15PFBoostedDeepDoubleBJetTagsPuppi:probQ'),
    deepDoubleBTagProbHName = cms.untracked.string('CA15PFBoostedDeepDoubleBJetTagsPuppi:probH'),
